...
public class addDealerDeviceToClientController {
	 ...
	 @GetMapping("/view_admin_complaints")
	    public String showComplaints(Model model) {
	        // Add any attributes to the model if necessary
	        return "view_admin_complaints"; // Ensure this matches the HTML file in your templates folder, e.g., map.html
	    }
	 
	 @GetMapping("/user_feedback")
	    public String showFeedback(Model model) {
	        // Add any attributes to the model if necessary
	        return "user_feedback"; // Ensure this matches the HTML file in your templates folder, e.g., map.html
	    }
